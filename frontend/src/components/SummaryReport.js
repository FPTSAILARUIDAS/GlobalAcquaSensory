...
const SummaryReport = () => {
  ...
  const getFinalConclusion = (ballot) => {
    // For Raw Water only, check Appearance and Odour
    ...
    <div className="min-h-screen bg-white p-8">
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-8">
                ...
                <div key={index} className="border-2 border-gray-300 rounded-lg p-4 bg-gray-50">
                  ...
                  <div className="border border-gray-300 bg-white p-2 rounded">
                    <img
                      ...
                      alt={`Signature of ${ballot.panelistName || `Panelist ${index + 1}`}`}
          ...
          {!session.ballots.some(b => b.signature) && (
            <p className="text-sm text-gray-500 italic">No signatures available</p>
          )}
        </div>
